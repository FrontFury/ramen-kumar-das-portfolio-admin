...
const AddTools = () => {
  ...
  // Toast Style & Custom zIndex to prevent navbar overlap
  const toastOptions = {
    duration: 3000,
    style: {
      background: "#163A2D",
      ...
      fontWeight: "600",
      borderRadius: "12px",
      zIndex: 99999, // Ensure it stays on top of any Navbar
    },
  };
  ...
  const handleAddCategory = () => {
    ...
    const newCat = { id: catId, label: newCatLabel };
  ...
  return (
    <div className="w-full max-w-4xl mx-auto bg-white rounded-2xl border border-emerald-100 p-6 sm:p-10 shadow-sm font-sans space-y-6">
      {/* Toast Container Top Level z-index Container */}
      <Toaster 
        position="top-center" 
        containerStyle={{
          top: 80, // Adds margin from top so Navbar doesn't cover it
          zIndex: 99999
        }}
      />
      ...
      <div className="flex items-center gap-3 border-b border-gray-100 pb-5">
        ...
        <div>
          <h1 className="text-2xl font-bold text-[#163A2D] font-['Playfair_Display',serif]">
            Add New Tech Tool
          </h1>
          <p className="text-xs text-gray-500">
            Insert new software, framework, or language into your stack ecosystem.
          </p>
        </div>
      </div>
            ...
            {showNewCatInput ? (
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-3 py-2 bg-[#163A2D] text-amber-300 text-xs font-semibold rounded-xl cursor-pointer"
                >
                  Add
                </button>
              </div>
