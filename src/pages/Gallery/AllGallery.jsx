...
const AllGallery = () => {
  ...
  // Image Upload handler inside Edit Modal
  const handleModalFileProcess = (file) => {
    ...
    reader.onloadend = () => {
      ...
      setValue("imageUrlInput", reader.result);
